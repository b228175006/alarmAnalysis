# 历史告警数据分析需求设计
---
* [历史告警数据分析需求设计](#历史告警数据分析需求设计)
*             * [1. 概述](#1-概述)
*                   * [2. 告警数据场景分析](#2-告警数据场景分析)
*                            * [2.1 基本应用场景](#21-基本应用场景)
*                                        * [2.1.1 告警数据统计](#211-告警数据统计)
*                                                    * [2.1.2 告警数据相关性分析](#212-告警数据相关性分析)
*                                                                   * [2.1.2.1 告警相关性类型](#2121-告警相关性类型)
*                                                                                  * [2.1.2.2 告警相关性分析方法](#2122-告警相关性分析方法)
*                                                                                                 * [2.1.2.3 告警相关性分析展示](#2123-告警相关性分析展示)
*                                                                                                          * [2.2 扩展应用场景](#22-扩展应用场景)
---
## 1. 概述
